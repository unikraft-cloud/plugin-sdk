module unikraft.com/cloud/pluginsdk/example

go 1.27.1

require (
	github.com/gin-gonic/gin v1.12.0
	unikraft.com/cloud/pluginsdk v0.0.0-20260917063831-9ed197542ce3
...
require (
	...
	codeberg.org/gruf/go-fastcopy v1.2.1 // indirect
	...
	unikraft.com/x/middleware v0.0.0-20260811021335-23b51b9e5a8a // indirect
)
